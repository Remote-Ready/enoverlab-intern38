...
export default function Resources() {
  return (
    <div className=" text-[#636262] text-sm p-16 container">
      <Header />
      ...
      <p className="text-sm font-light mb-4">
        ...
        formal agreement to create with another individual or entity, anything.
        This strategy will help foster a sense of importance and inclusion on
        all sides.
      </p>
      <p className="text-sm font-light mb-4">
        Several contract types utilize terms and conditions. When there is a
        ...
        conditions with the other side before finalizing anything. This strategy
        will help foster a sense of importance and inclusion on all sides.
      </p>
